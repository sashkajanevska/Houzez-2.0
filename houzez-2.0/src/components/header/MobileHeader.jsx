...
import {
  ...
  toggleDropdownMenu,
  toggleUserMenu,
} from "../utils/mobileHeaderHandlers";

export default function MobileHeader({ openLoginOverlay }) {
    ...
    <div className="header-mobile">
      <div className="header-mobile-inner">
        <div
          ...
          onClick={() => {
            toggleNavMenu(activeMenu, setActiveMenu);
          }}
        >
        ...
        <div
          ...
          onClick={() => {
            toggleUserMenu(activeMenu, setActiveMenu);
          }}
        >
