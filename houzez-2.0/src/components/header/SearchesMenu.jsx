const SearchesMenu = () => {
    return (
      ...
      >
        <li>
          <a href="" className="new-feature">ELEMENTOR SEARCH BUILDER</a>
        </li>
        ...
        <li>
          <a href="" className="new-feature">SEARCH V3 — HEADER</a>
        </li>
  
        <li>
          <a href="" className="new-feature">SEARCH V3 — BELOW BANNER</a>
        </li>
        ...
        <li>
          <a href="" className="new-feature">BANNER SEARCH WITH TABS</a>
        </li>
